...
map_dat2=map_dat2[map_dat2.County_Name == County_Name]
...
st.markdown('_The National Risk Index (NRI) is a dataset maintained by FEMA that tracks census tract level disaster risk across 18 perils. In addition to peril specific risk, the NRI contains aggregate risk metrics such as Composite Risk Score, Social Vulnerability Score, and Expected Annual Financial Loss. The NRI is one of the most comprehensive publicly available datasets related to natural disaster and climate risk. More information can be found on the NRI website: https://hazards.fema.gov/nri/_')
...
map_dat3=map_dat3[map_dat3.County_Name == County_Name]
